...
LABEL version="1.0.0"
LABEL repository="https://github.com/convox/action-delete"
LABEL homepage="https://convox.com/convox"
LABEL maintainer="Convox <support@convox.com>"

LABEL "com.github.actions.name"="Convox Destroy"
LABEL "com.github.actions.description"="Delete an app on Convox"
